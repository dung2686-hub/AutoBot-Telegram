...
VI = {
    ...
    "slot_duration_title": "⏳ <b>Chọn thời gian cho {name}:</b>",
    "slot_email_prompt": "📧 <b>Vui lòng nhập email để nhận slot:</b>\n\n<i>Ví dụ: email_cua_ban@gmail.com</i>\n\nHoặc bấm ❌ Hủy để quay lại.",
    "slot_email_invalid": "❌ Email không hợp lệ. Vui lòng nhập lại email đúng định dạng.",
    "btn_buy": "🛒 Mua ngay",
    "btn_quantity_up": "➕",
    "btn_quantity_down": "➖",
