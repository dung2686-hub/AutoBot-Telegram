...
EN = {
    ...
    "slot_duration_title": "⏳ <b>Select duration for {name}:</b>",
    "slot_email_prompt": "📧 <b>Please enter your email to receive the slot:</b>\n\n<i>Example: your_email@gmail.com</i>\n\nOr click ❌ Cancel to go back.",
    "slot_email_invalid": "❌ Invalid email. Please enter a valid email address.",
    "btn_buy": "🛒 Buy Now",
    "btn_quantity_up": "➕",
    "btn_quantity_down": "➖",
